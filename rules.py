...
RULES_BASE = {
  ...
  "仕事内容・募集条件":[
    ...
    {"pattern": r"未経験\s*大歓迎|未経験\s*歓迎|学歴\s*不問|経歴\s*不問|ポテンシャル採用|人物重視", "weight": 2, "reason": "要件が甘く大量採用/高離職の懸念"},
    ...
    {"pattern": r"(若手活躍中|若手が活躍|若い人でも活躍できる)", "weight": 1, "reason": "若手を強調 → 離職率が高い可能性"},
  ...
  "給与・待遇":[
    ...
    # みなし/固定残業の強化（40h以上で強加点）
    {"pattern": r"(固定|みなし).{0,8}残業[^0-9]*(4[0-9]|[5-9][0-9])\s*時間", "weight": 4, "reason": "固定/みなし残業40h以上（強リスク）"},
    {"pattern": r"(固定残業|みなし残業)\s*(\d+)\s*時間", "weight": 3, "reason": "固定/みなし残業の内包"},
  ...
  "勤務時間・休日":[
    ...
    # 月60〜80hの過剰残業を強く加点
    {"pattern": r"月(平均)?\s*(6[0-9]|7[0-9]|80)\s*([hｈ時間]|時間)", "weight": 3, "reason": "月60〜80h残業の示唆（高リスク）"},
    # 繁忙期土曜出勤あり
    {"pattern": r"繁忙期.*土曜出勤.*(あり|有|発生)", "weight": 1, "reason": "休日出勤が想定される"},
  ...
  "社風・福利厚生":[
    ...
    {"pattern": r"頑張るあなたを全力応援", "weight": 1, "reason": "抽象的な精神論の強調"},
  ],

  # 求人票デザイン/文面のサイン
  "求人票サイン":[
    {"pattern": r"平均年齢.?20代|20代が中心", "weight": 2, "reason": "平均年齢が若い/20代中心 → 高離職率の可能性"},
